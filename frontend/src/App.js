...
// --- Estilos CSS en formato de Objeto JavaScript (Paleta de Colores Vibrante) ---
const styles = {
    // Layout & General
    appContainer: {
        backgroundColor: '#f8f9fa', // Un gris muy claro para el fondo
        minHeight: '100vh',
    ...
    buttonRed: {
        backgroundColor: '#dc3545', // Rojo para acciones de "cancelar"
    },
    // Alertas
    alertError: {
